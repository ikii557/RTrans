            ...
            <div id="sidebar-collapse">
                <div class="admin-block d-flex">
                    ...
                    <div class="admin-info">
                        <div class="font-strong">Rifki Hadid Anwar</div><small>Administrator</small></div>
                </div>
                <ul class="side-menu metismenu">
                    ...
                    <li>
                        ...
                        <ul class="nav-2-level collapse">
                            ...
                            <li>
                                <a href="panels.html">Summary Year</a>
                            </li>
                            {{-- <li>
                    ...
                    <li>
                        <a href="javascript:;"><i class="sidebar-item-icon fa fa-table"></i>
                            <span class="nav-label">HOTEL</span><i class="fa fa-angle-left arrow"></i></a>
                        <ul class="nav-2-level collapse">
                            <li>
                                <a href="hotel">All Hotel</a>
                            </li>
                            <li>
                                <a href="datatables.html">INCOM HOTEL</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        <a href="javascript:;"><i class="sidebar-item-icon fa fa-bar-chart"></i>
                            <span class="nav-label">TIKET</span><i class="fa fa-angle-left arrow"></i></a>
                        <ul class="nav-2-level collapse">
                            <li>
                                <a href="charts_flot.html">ALL INCOM</a>
                            </li>
                            <li>
